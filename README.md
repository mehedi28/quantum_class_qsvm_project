...
| `circuit_feature_map.png` | ZZ feature map circuit U(x), forward pass. Generated by Cell 13. |
| `circuit_full_kernel.png` | Full quantum kernel circuit U(x₁) followed by U†(x₂). Generated by Cell 13. |
| `qsvm_results.png` | 2x2 summary: kernel heatmap, confusion matrix, per-class F1, sample-size crossover. Generated by Cell 18. |
| `confusion_matrices.png` | Side-by-side classical SVM vs QSVM confusion matrices at 200 samples. Generated by Cell 19. |
| `scaling_qsvm_3point.png` | QSVM accuracy scaling across 100, 300, and 500 training samples. Generated by Cell 25. |
